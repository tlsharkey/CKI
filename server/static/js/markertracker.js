...
const imageFramePipelineModule = () => {
    ...
    const axis = () => {
        ...
        const xAxis = new THREE.Mesh(cylinder, new THREE.MeshBasicMaterial({
            color: MANGO
        }))
        const yAxis = new THREE.Mesh(cylinder, new THREE.MeshBasicMaterial({
            color: CHERRY
        }))
        const zAxis = new THREE.Mesh(cylinder, new THREE.MeshBasicMaterial({
            color: MINT
        }))
